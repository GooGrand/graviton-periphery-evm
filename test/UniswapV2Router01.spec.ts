...
describe('UniswapV2Router{01,02}', () => {
    const routerVersion = RouterVersion.UniswapV2Router01
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.UniswapV2Router01]: 106518,
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.UniswapV2Router01]: 109696,
              [RouterVersion.UniswapV2Router02]: 109696
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
